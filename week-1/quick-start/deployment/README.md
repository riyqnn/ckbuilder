...
offckb deploy --network devnet --target <contract-binary-path> --output /home/riyan/Downloads/Projects/ockb/week-1/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /home/riyan/Downloads/Projects/ockb/week-1/deployment
```
